...
$sql_update = "UPDATE CPA35 SET ESTADO = 2, ID_ESTADO_ORDEN_COMPRA = 2, AUTORIZO = ?, FEC_AUTORI = GETDATE(), HORA_AUTOR = FORMAT(GETDATE(), 'HHmm'), TERM_AUTORIZACION = 'APP_MOVIL', USUA_ULTIMA_MODIFICACION = ?, HORA_ULTIMA_MODIFICACION = FORMAT(GETDATE(), 'HHmmss'), TERM_ULTIMA_MODIFICACION = 'APP_MOVIL' WHERE N_ORDEN_CO = ? AND ESTADO = 1";
